function Table(item)
{
	...
	for(var i in data)
	{
		$table.find('tbody').append('<tr><td><svg height="15" width="200"><g><text text-anchor="start" x="21" y="12.75" font-family="Arial" font-size="15" stroke="none" stroke-width="0" fill="#222222">'+data[i].name+'</text><rect width="15" height="15" stroke="none" stroke-width="0" fill="'+data[i].color+'"/></g></svg></td><td><div class="value"></div><div class="timestamp"></div></td><td><div class="value"></div><div class="timestamp"></div></td><td><div class="value"></div></td></tr>');
	}
